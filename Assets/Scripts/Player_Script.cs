...
void  Awake (){
    ...
    void  Start (){
        ...
        GetComponent<Animation>()["back_loop"].speed = 1.5f; 
	    GetComponent<Animation>()["start"].speed = 1.0f; 
	    GetComponent<Animation>()["start_ball"].speed = 1.0f; 
	    GetComponent<Animation>()["run"].speed = 1.2f; 
	    GetComponent<Animation>()["run_ball"].speed = 1.0f; 
	    GetComponent<Animation>()["pass"].speed = 1.8f; 
	    GetComponent<Animation>()["repose"].speed = 1.0f; 
	    GetComponent<Animation>()["change_sense"].speed = 1.3f; 

	    GetComponent<Animation>()["enter"].speed = 1.2f;	
	    ...
	    if ( sphere.inputPlayer == gameObject ) { 
		    ...
		    if ( sphere.fVertical != 0.0f || sphere.fHorizontal != 0.0f ) {
			    ...
			    if ( sphere.owner == gameObject ) {
				    ...
				    if ( GetComponent<Animation>().IsPlaying("repose") ) { 
					    GetComponent<Animation>().Play("start_ball");
					    speedForAnimation = 1.0f;
				    }
					
				    if ( GetComponent<Animation>().IsPlaying("start_ball") == false ) 
				    ...
				    if ( GetComponent<Animation>().IsPlaying("start") == false ) 
